...
/////////////////////// Keyframe Compression !! ///////////////////////////
    ...
    f.open("build/Db/CompressionResult/"+finalStr+"KeyframeIQP_Compression_Result_"+string(argv[2])+"_"+string(argv[4])+"_"+string(argv[5])+"_"+string(argv[6])+"_"+string(argv[7])+"_.txt", ios::out);
